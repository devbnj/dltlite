...
module.exports = function (RED) {
    ...
    function dbliteAppend(n) {
        RED.nodes.createNode(this, n);
        this.dbname = n.db;
        var node = this;

        node.doConnect = function () {
            sqliteEnc.connect(node.dbname);
    ...
    RED.nodes.registerType("dblite-append", dbliteAppend);

    function dbliteAppendIn(n) {
        RED.nodes.createNode(this, n);
        this.mydb = n.mydb;
        ...
        if (node.mydbConfig) {
            ...
            node.error("dblite database not configured");
        }
    }
    RED.nodes.registerType("dblite", dbliteAppendIn);
}