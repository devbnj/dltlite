module.exports = function (RED) {
    ...
    RED.nodes.registerType("dblite-redisConfig", RedisConfig);
    ...
    RED.nodes.registerType("dblite-redis-in", RedisIn);
    ...
    RED.nodes.registerType("dblite-redis-out", RedisOut);
    ...
    RED.nodes.registerType("dblite-redis-command", RedisCmd);
